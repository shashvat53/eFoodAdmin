...
const DeliverymanListTable = ({ data }) => {
  const listArr = [
    "SL",
    "Name",
    "Contact",
  ...
  const Item = (elem, ind) => {
    return (
      <>
        ...
        <span>{elem.TotalOrders}</span>
        <span><ToggleSwitch value={elem.is_active} onChange={changeToggleValue} id={ind}/></span>
...
export default DeliverymanListTable;
