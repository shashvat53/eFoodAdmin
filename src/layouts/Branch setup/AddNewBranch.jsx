  ...
  <form action="">
                <div className='w-full grid grid-flow-row md:grid-cols-2 sm:grid-cols-1 min-h-fit rounded-xl overflow-hidden border shadow-lg pb-4 pt-5 my-5'>
                    <div className=' w-full h-1/2  md:h-full px-5 py-2'>
                        ...
                        <input type="text" placeholder='Name' className='w-full px-2 py-2 mt-2 rounded-md border mb-4 ' />
                    </div >
                    <div className=' w-full h-1/2  md:h-full px-5 py-2'>
                    ...
                    <div className=' w-full h-1/2  md:h-full px-5 py-2'>
                        ...
                        <input type="text" placeholder='Email' className='w-full px-2 py-2 mt-2 rounded-md border mb-4 ' />
                    </div >
                    <div className=' w-full h-1/2  md:h-full px-5 py-2'>
                        <label htmlFor="Title">Password<span className='text-red-500'> *</span></label>
                        <input type="text" placeholder='Password' className='w-full px-2 py-2 mt-2 rounded-md border mb-4 ' />
                    </div >
                    ...
                    <div className=' w-full h-1/2  md:h-full px-5 py-2 flex flex-col items-center justify-center'>
                        <p className='text-center'>Branch Image <span className='text-red-500'> *  ( Ratio 1:1 )</span> </p>
                    ...
                    <div className=' w-full h-1/2  md:h-full p-5 flex flex-col items-center justify-center'>
                        <p className='text-center'>Branch Cover Image<span className='text-red-500'> *  ( Ratio 3:1 )</span> </p>
                        <label htmlFor="ProfileImage">
                            <div>
                                <input type="file" id='ProfileImage' accept='image/*' className='hidden' />
                                <img className='mt-5' src="https://efood-admin.6amtech.com/public/assets/admin/img/icons/upload_img2.png" alt="" />
                ...
                <div className=' w-full h-1/2  md:h-full px-5 py-2'>
                        ...
                        <input type="number" placeholder='Latitude' className='w-full px-2 py-2 mt-2 rounded-md border mb-4 ' />
                    </div >
                <div className=' w-full h-1/2  md:h-full px-5 py-2'>
