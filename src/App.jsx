        ...
        <>
          ...
          >
            ...
            <Routes>
              ...
              />
              <Route path="/Order/Failed To Deliver" element={<Failed />} />
              <Route path="/Order/Canceled" element={<Canceled />} />
              <Route path="/Order/Scheduled" element={<Schedule />} />
              <Route
              ...
              <Route
                path="/CategorySetup/SubCategory"
                element={<SubCategory />}
              />
              ...
              <Route
                path="/CustomerWallet/WalletBonusSetup"
                element={<WalletBonusSetup />}
              />
              <Route path="/CustomerWallet/Report" element={<WalletReport />} />
              <Route
                path="/CustomerLoyaltyPoint/Report"
                element={<LoyalityReport />}
              />
              <Route
                path="/Employees/EmployeeSetup"
                element={<EmployeeSetup />}
              />
              <Route
                path="/Employees/EmployeeRoleSetup"
                element={<EmployeeRoleSetup />}
              />
              <Route
                path="/subscribed-email"
                element={<SubscribedCustomers />}
              />
              <Route
                path="/Deliveryman/DeliverymanList"
                element={<DeliveryManList />}
              />
              <Route
                path="/Deliveryman/AddNewDeliveryman"
                element={<AddNewDeliveryman />}
              />
              <Route
                path="/Deliveryman/DeliverymanReviews"
                element={<DeliveryMenReview />}
              />
              <Route
                path="/Deliveryman/NewJoiningRequest"
              ...
              <Route
                path="/3rdParty/3rdPartyConfiguration"
                element={<ThirdPartyNav />}
              />
              <Route
                path="/3rdParty/FirebaseNotification"
                element={<FirebaseNotification />}
              />
              <Route
                path="/3rdParty/OfflinePaymentMethod"
                element={<OfflinePaymentMethodSetup />}
              />
              ...
              <Route
                path="/Table/PromotionSetup"
                element={<BranchPromotionSetup />}
              />
